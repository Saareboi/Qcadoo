...
<head>
	...
	<c:choose>
		<c:when test="${useCompressedStaticResources}">
			...
			<script type="text/javascript" src="${pageContext.request.contextPath}/qcadooView/public/js/core/lib/_jquery-1.4.2.min.js?ver=2019_09_20_15_46"></script>
		...
		<c:otherwise>
			<link rel="stylesheet" href="${pageContext.request.contextPath}/qcadooView/public/css/core/login.css?ver=2019_09_20_15_46" type="text/css" />
